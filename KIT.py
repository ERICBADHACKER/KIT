...
#AUTHOR : CHIGOZIEWORLDWIDE (KIT)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO KIT
...
header = {"user-agent": '[Mozilla/5.0 (Windows; U; Windows NT 6.1; ko-KR) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/533.20.27;]',
